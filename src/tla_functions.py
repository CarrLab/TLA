'''
    Tumor Landscape Analysis (TLA) - TLA General Functions
    ######################################################

    Library of functions for the opperation of all TLA modules
...
def circle(rin, normal=False):
    ...
    If NOT normalized it gives a Kernel Abundance Estimator (KAE), which is 
    the sum of points inside each neigborhood defined by the kernel
...
def gkern(sig, normal = True):
    ...
    If NOT normalized it gives a Kernel Abundance Estimator (KAE), which is
    the sum of points inside each neigborhood defined by the (weighted) kernel
...
###############################################################################
"""
# %% Archived functions (NOT yet used)
