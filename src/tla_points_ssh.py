...
def SSH(sid, data, classes, 
    ...
    from tla_functions import SSH_factor_detector_df
    from tla_functions import SSH_risk_detector_df
    from tla_functions import SSH_interaction_detector_df
    from tla_functions import SSH_ecological_detector_df
...
if __name__ == "__main__":
    ...
    # Create the parser
    my_parser = ArgumentParser(prog="tla_points_ssh",
                               description="### Processing SSH module " +
